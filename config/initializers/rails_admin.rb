# RailsAdmin config file. Generated on November 10, 2012 15:56
...
RailsAdmin.config do |config|
  ...
  # config.excluded_models = ['AfgOpportunity', 'Checkin', 'Event', 'HelpArticle', 'Neighborhood', 'Notification', 'Org', 'Participation', 'Privacy', 'Prop', 'Role', 'Search', 'Skill', 'User', 'UserNotification']

  # Include specific models (exclude the others):
  # config.included_models = ['AfgOpportunity', 'Checkin', 'Event', 'HelpArticle', 'Neighborhood', 'Notification', 'Org', 'Participation', 'Privacy', 'Prop', 'Role', 'Search', 'Skill', 'User', 'UserNotification']
  ...
  # config.model 'AfgOpportunity' do

  #   # You can copy this to a 'rails_admin do ... end' block inside your afg_opportunity.rb model definition
  ...
  #     configure :latlong, :string 
  #     configure :location_name, :string 
  #     configure :startDate, :datetime 
  #     configure :endDate, :datetime 
  #     configure :sponsoringOrganizationName, :string 
  #     configure :xml_url, :string 
  #     configure :skills, :string 
  #     configure :city, :string 
  #     configure :description, :text 
  #     configure :reverse_geocoded, :boolean 
  #     configure :street, :string 
  #     configure :neighborhood_string, :string 
  ...
  #   # You can copy this to a 'rails_admin do ... end' block inside your checkin.rb model definition
  ...
  # config.model 'HelpArticle' do

  #   # You can copy this to a 'rails_admin do ... end' block inside your help_article.rb model definition
  ...
  #   # You can copy this to a 'rails_admin do ... end' block inside your neighborhood.rb model definition
  ...
  #   # You can copy this to a 'rails_admin do ... end' block inside your org.rb model definition
  ...
  #     configure :following, :has_and_belongs_to_many_association 
  #     configure :participations, :has_many_association 
  ...
  #     configure :admins, :has_and_belongs_to_many_association 
  ...
  #   # You can copy this to a 'rails_admin do ... end' block inside your privacy.rb model definition
  ...
  #     configure :id, :integer 
  #     configure :user_id, :integer         # Hidden 
  #     configure :upcoming_events, :string 
  ...
  #   # You can copy this to a 'rails_admin do ... end' block inside your prop.rb model definition
  ...
  #     configure :users_found, :integer 
  #     configure :orgs_found, :integer 
  #     configure :events_found, :integer 
  #     configure :help_articles_found, :integer 
  ...
  #   # You can copy this to a 'rails_admin do ... end' block inside your user_notification.rb model definition
